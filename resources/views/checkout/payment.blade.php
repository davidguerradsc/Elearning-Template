                ...
                <div class="order-details my-5">
                    ...
                    <table class="table table-striped">
                        <tbody>
                            ...
                            @php
                            $tax = \Cart::session(Auth::user()->id)->getTotal() - (\Cart::session(Auth::user()->id)->getTotal() / 1.2) ;
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <p>Prix d'origine:</p>
                            <p>{{ \Cart::getSubTotal() - $roundedTax }} €</p>
                        </div>
                        <hr>
                        <div class="d-flex justify-content-between">
                            <p>Taxe:</p>
...
@section('stripe')
    <script>
        ...
        var stripe = Stripe(
            'pk_test_51I8nvJEJXce0AKYV9LCaEM4EWhrGY6vRGM4jHElOcdYCRVEy2T8T1Vj8N4olw074iaTYQlfaB0OGkZIU9bI6Rqta00zqzJWlWf'
        );

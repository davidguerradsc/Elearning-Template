            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="hero-text">
                        ...
                        <a href="{{ route('register') }}" class="primary-btn my-5">Nous rejoindre</a>
                    </div>
                </div>
                <div class="col-lg-5">
        ...
        <div class="d-flex justify-content-around">
            @foreach ($instructors as $instructor)
                <div class="member-item set-bg"
                    data-setbg="https://uploads-ssl.webflow.com/5bddf05642686caf6d17eb58/5dc2fd00c29f7abeadd7c332_gPZwCbdS.jpg">
                    <div class="mi-social">
